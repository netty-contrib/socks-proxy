...
public class DefaultSocks5PasswordAuthRequestTest {
    ...
    public void testConstructorParamsAreNotNull() {
        assertThrows(NullPointerException.class, () -> new DefaultSocks5PasswordAuthRequest(null, ""));
        assertThrows(NullPointerException.class, () -> new DefaultSocks5PasswordAuthRequest("", null));
    }
    ...
    public void testUsernameOrPasswordLengthIsLessThan255Chars() {
        assertThrows(IllegalArgumentException.class, () -> new DefaultSocks5PasswordAuthRequest(
                "passwordpasswordpasswordpasswordpasswordpasswordpassword" +
                        ...
                        "passwordpasswordpasswordpasswordpasswordpasswordpassword",
                "password"));
        assertThrows(IllegalArgumentException.class, () -> new DefaultSocks5PasswordAuthRequest("password",
                "passwordpasswordpasswordpasswordpasswordpasswordpassword" +
                        "passwordpasswordpasswordpasswordpasswordpasswordpassword" +
                        "passwordpasswordpasswordpasswordpasswordpasswordpassword" +
                        "passwordpasswordpasswordpasswordpasswordpasswordpassword" +
